...
class Config
{
	public static function make(string $file, string $data): void
	{
	 ...
	 */
	public static function interactive(SymfonyStyle $style): array
	{
		$env = [];
		...
		$env["remote"]["keepReleases"] = $style->ask("How many releases should be kept before pruning?", "5", function(string $number): int {
